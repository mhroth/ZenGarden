...
MessageLessThanOrEqualTo::MessageLessThanOrEqualTo(float constant, PdGraph *graph) : MessageObject(2, 1, graph) {
  init(constant);
}
...
void MessageLessThanOrEqualTo::init(float constant) {
