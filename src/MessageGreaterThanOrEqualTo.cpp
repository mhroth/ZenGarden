...
MessageGreaterThanOrEqualTo::MessageGreaterThanOrEqualTo(float constant, PdGraph *graph) : MessageObject(2, 1, graph) {
  init(constant);
}
...
void MessageGreaterThanOrEqualTo::init(float constant) {
...
PdMessage *MessageGreaterThanOrEqualTo::newCanonicalMessage(int outletIndex) {
