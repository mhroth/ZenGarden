...
MessageGreaterThan::MessageGreaterThan(PdMessage *initMessage, PdGraph *graph) : MessageObject(2, 1, graph) {
...
MessageGreaterThan::MessageGreaterThan(float constant, PdGraph *graph) : MessageObject(2, 1, graph) {
  init(constant);
}
...
void MessageGreaterThan::init(float constant) {
