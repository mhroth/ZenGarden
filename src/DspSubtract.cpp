...
DspSubtract::DspSubtract(int blockSize, char *initString) :
DspMessageInputDspOutputObject(2, 1, blockSize, initString) {
  constant = 0.0f;
}

DspSubtract::DspSubtract(float constant, int blockSize, char *initString) :
DspMessageInputDspOutputObject(2, 1, blockSize, initString) {
...
void DspSubtract::processDspToIndex(int newBlockIndex) {
